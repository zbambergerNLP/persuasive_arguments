...
def save_hidden_state_outputs(fine_tuned_model_path: str,
                              probing_dataset: preprocessing.CMVDataset,
...
def create_train_and_test_datasets(key_phrase: str,
        ...
        typing.Tuple[preprocessing.CMVDataset, preprocessing.CMVDataset]):
    ...
    hidden_state_dataset_train = preprocessing.CMVDataset(hidden_state_dataset[constants.TRAIN])
    hidden_state_dataset_test = preprocessing.CMVDataset(hidden_state_dataset[constants.TEST])
...
def load_hidden_state_outputs(probing_dir_path: str = None,
        ...
        typing.Mapping[str, typing.Mapping[str, preprocessing.CMVDataset]]):
    ...
    :return: A dictionary mapping the probing model type to the train and test datasets it produces. Concretely,
        ...
        instance of 'preprocessing.CMVDataset'."""
...
def probe_with_logistic_regression(
        hidden_state_datasets: typing.Mapping[str, typing.Mapping[str, preprocessing.CMVDataset]],
        base_model_type: str) -> (
...
def probe_model_on_task(probing_dataset: preprocessing.CMVDataset,
                        probing_model: str,
